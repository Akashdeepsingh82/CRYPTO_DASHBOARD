...
import { Button, Card, Flex, HStack, Icon } from '@chakra-ui/react'
import { AiOutlineDownload } from 'react-icons/ai'
import { Tabs, TabList, TabPanels, Tag,Tab, TabPanel } from '@chakra-ui/react'
...
const TransactionPage = () => {
  ...
  return (
    <DashboardLayout title="Transactions"><Flex justify ="end" mt="6" mb="3">
