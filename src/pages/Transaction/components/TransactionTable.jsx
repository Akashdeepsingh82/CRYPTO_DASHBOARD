    ...
    tableData.map((data)=>(<Tr key= {data.id}>
      <Td fontSize="sm" fontWeight="medium">{data.id}</Td>
       ...
       <Td> <Stack spacing={0}>
        ...
        <Text fontSize="xs" color="black.60">{data.time}</Text></Stack></Td>
        ...
        <Text fontSize="xs" color="black.60">{data.type?.tag}</Text></Stack></Td>
     
          <Td fontSize="sm" fontWeight="medium">{data.amount}</Td>
           <Td fontSize="sm" fontWeight="medium">
            <Tag bg={statusColor[data.status]} color="white" borderRadius="full">{data.status}</Tag></Td>
    </Tr>
